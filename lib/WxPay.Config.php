...
class WxPayConfig
{
	 ...
	 * @var string
	 */
	const APPID = WXPAY_APPID;//'wx426b3015555a46be';
	const MCHID = WXPAY_MCHID;//'1900009851';
	const KEY = WXPAY_KEY;//'8934e7d15453e97507ef794cf7b0519d';
	const APPSECRET = WXPAY_APPSECRET;//'7813490da6f1265e4901ffb80afaa36f';
	 ...
	 * @var path
	 */
	const SSLCERT_PATH = WXPAY_SSLCERT_PATH;//'../cert/apiclient_cert.pem';
	const SSLKEY_PATH = WXPAY_SSLKEY_PATH;//'../cert/apiclient_key.pem';
	 ...
	 * @var unknown_type
	 */
	const CURL_PROXY_HOST = WXPAY_CURL_PROXY_HOST;//"0.0.0.0";//"10.152.18.220";
	const CURL_PROXY_PORT = WXPAY_CURL_PROXY_PORT;//0;//8080;
	 ...
	 * @var int
	 */
	const REPORT_LEVENL = WXPAY_REPORT_LEVENL;//1;
}
